...
**English:** [choose-backend-en.md](./choose-backend-en.md)
...
│   └── → github-cli-setup.md + /setup (ou devkit:setup -- --yes)
│
├── Jira
...
1. [github-cli-setup.md](./github-cli-setup.md) — `gh auth login`
2. **`/setup`** ou `npm run devkit:setup -- --yes`
...
**Setup:** veja [setup-quickstart §3.1](./setup-quickstart.md#passo-31--escolher-backend-github--jira--outros) para env vars de cada um.
...
|---------------|-----------|
| Criar cards | Peça *"Refina X em cards"* ou veja [guia-completo §4](./guia-completo.md#4-como-funcionam-os-cards) |
| Evoluir cards | *"mova CARD-ID para Done"* — [card-refiner](../skills/planning/card-refiner/SKILL.md) |
| Auditar repo | [primeira-auditoria.md](./primeira-auditoria.md) |
