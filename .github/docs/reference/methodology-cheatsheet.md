...
| **Runtime rule** | IDE-specific hints (Cursor, Copilot, Claude) | Always-on behavior for the assistant | Yes (`.cursor/rules/hyperion.mdc`, `CLAUDE.md`, `instructions/`) |
...
- [Fresh clone vs generated artifacts](../README.md#fresh-clone-vs-generated-artifacts) (PT anchor; EN section in [docs/README.md](../README.md))
