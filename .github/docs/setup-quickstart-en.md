...
**Português:** [setup-quickstart.md](./setup-quickstart.md)
...
> **Summary:** for GitHub "plug and play", install `gh` and run `gh auth login`. Tutorial: **[github-cli-setup-en.md](./github-cli-setup-en.md)**
...
1. Install `gh`: **[github-cli-setup-en.md](./github-cli-setup-en.md)** (Windows / macOS / Linux)
2. Log in:
...
Full guide with decision tree: **[choose-backend-en.md](./choose-backend-en.md)**
...
In CI, `.github/workflows/sync-cards.yml` runs automatically when cards change.
...
|----------|----------------|
| `GITHUB_TOKEN` / `gh auth login` | GitHub sync local — [gh tutorial](./github-cli-setup-en.md) |
...
| Token missing | `gh auth login` — [tutorial](./github-cli-setup-en.md) or `PROJECT_SYNC_TOKEN` |
...
4. **Audit** → [first-audit-en.md](./first-audit-en.md)
